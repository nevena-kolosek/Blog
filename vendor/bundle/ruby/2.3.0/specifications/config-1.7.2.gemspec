...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<dry-validation>.freeze, ["< 1.0.0", ">= 0.12.2", "~> 0.12"])
      s.add_development_dependency(%q<rails>.freeze, [">= 5.2.2", "~> 5.2"])
      ...
      s.add_dependency(%q<dry-validation>.freeze, ["< 1.0.0", ">= 0.12.2", "~> 0.12"])
      s.add_dependency(%q<rails>.freeze, [">= 5.2.2", "~> 5.2"])
